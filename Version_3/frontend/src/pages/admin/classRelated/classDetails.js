...
const ClassDetails = () => {
    ...
    const studentActions = [
        {
            icons: <PersonAddAlt1Icon color="primary" />, name: 'Add New Student', action: () => navigate('/Admin/class/addstudents/' + classID)
        },
        {
            ...
            <>
                {getresponse ? (
                    ...
                    <>
                        ...
                        <SpeedDialTemplate action={studentActions} />
                    </>
                )}
            </>
        )
