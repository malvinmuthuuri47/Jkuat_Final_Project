...
const ViewSubject = () => {
    ...
    const StudentMarksButtonHaver = ({ row }) => {
        return (
            <>
                <BlueButton
                    variant="contained"
    ...
    const SubjectStudentsSection = () => {
        return (
            <>
                {getresponse ? (
                    <>
                        <Box sx={{ dsplay: 'flex', justifyContent: 'flex-end', marginTop: '16px' }}>
                            <GreenButton
                                variant="contained"
                    ...
                    <>
                        ...
                        {selectedSection === 'marks' && 
                            <TableTemplate buttonHaver={StudentMarksButtonHaver} columns={studentColumns} rows={studentRows} />
                        }
