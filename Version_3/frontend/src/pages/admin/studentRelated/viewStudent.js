...
const ViewStudent = () => {
    ...
    const deleteHandler = (id, delAddress) => {
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Button variant="contained" sx={styles.styleButton} onClick={() => navigate('/Admin/students/student/marks/' + studentID)}>
                        Add Marks
                    </Button>
                </>
            )
        ...
        return (
            <>
                ...
                <>
                    ...
                    <Paper sx={{ position: 'fixed', bottom: 0, left: 0, rigth: 0 }} elevation={3}>
                        <BottomNavigation value={selectedSection} onChange={handleSectionChange} shoWlabels>
                            <BottomNavigationAction
                                label="Table"
                                value="table"
